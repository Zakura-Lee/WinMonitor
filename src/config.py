...
SUS_PATH_WHITELIST = [
    r"c:\\users\\admin\\downloads\\setup.exe",
    r"c:\\users\\admin\\downloads\\install.exe",
]
...
# 网络监控配置
HIGH_RISK_REMOTE_PORTS = {4444, 1337, 3389}
SQL_REMOTE_PORTS = {}
ATTACK_STATUSES = {"SYN_SENT"}
...
SERVICE_PORT = 5000
APP_SECRET_KEY = "replace-with-a-secure-secret"
